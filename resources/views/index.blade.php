...
<head>
    ...
    <!-- All CSS is here
	============================================ -->
    <link rel="stylesheet" href={{asset('css/vendor/proximanova.css')}} />
    ...
    <link rel="stylesheet" href={{asset('css/plugins/slinky.min.css')}} />
...
<body>
    <div class="main-wrapper wrapper-2">
                        ...
                        <div class="header-action-wrap">
                            <div class="header-action-cart">
                                <a class="cart-active" href="#">
                                    <img class="injectable" src={{asset('images/icon-img/bag.svg')}} alt="">
                ...
                <div class="cart-content">
                    ...
                    <ul>
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="product-details.html"><img src={{asset('images/product/product-1.png')}}
                                        alt=""></a>
                            </div>
                        ...
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="product-details.html"><img src={{asset('images/product/product-2.png')}}
                                        alt=""></a>
                            </div>
                            <div class="cart-title">
            ...
            <div class="slider-active-1 nav-style-1">
                <div
                    ...
                    <div class="slider-img">
                        <img src={{asset('/images/slider/slider-1.png')}} alt="">
                    </div>
                ...
                <div
                    class="single-slider-wrap slider-height-1 custom-d-flex custom-align-item-center single-animation-wrap">
                    <div class="slider-img">
                        <img src={{asset('/images/slider/slider-2.png')}} alt="">
                    </div>
                    <div class="slider-content slider-animated-1">
                        <h3 class="animated">BEST SALE THIS WEEK</h3>
            ...
            <div class="trend-product-wrap">
                <div class="container-fluid p-0">
                    <div class="product-img-position">
                        <img src={{asset('/images/product/trend.png')}} alt="">
                    </div>
                    <div class="row gx-0">
                    ...
                    <div class="row mb-n6">
                        <div class="col-lg-4 col-md-4 mb-6">
                            <div class="features-wrap text-center" data-aos="fade-up" data-aos-delay="200">
                                <div class="features-img">
                                    <img class="injectable" src={{asset('images/icon-img/cut.svg')}} alt="">
                                </div>
                                <h3>New Discount</h3>
                        ...
                        <div class="col-lg-4 col-md-4 mb-6">
                            <div class="features-wrap text-center" data-aos="fade-up" data-aos-delay="300">
                                <div class="features-img">
                                    <img class="injectable" src={{asset('/images/icon-img/gift.svg')}} alt="">
                                </div>
                                <h3>Gift Vouchers</h3>
                                <p>Suspendisse sit amet accumsan massa, et ullamcorper purus</p>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 mb-6">
                            <div class="features-wrap text-center" data-aos="fade-up" data-aos-delay="400">
                                <div class="features-img">
                                    <img class="injectable" src={{asset('/images/icon-img/car.svg')}} alt="">
                                </div>
                                <h3>Free Delivery</h3>
                                <p>Suspendisse sit amet accumsan massa, et ullamcorper purus</p>
                            </div>
                        ...
                        <div class="row mb-n10">
                                ...
                                <div class="product-wrap" data-aos="fade-up" data-aos-delay="200">
                                    <div class="product-img img-zoom mb-4">
                                        <a href="product-details.html">
                                            <img class="default-img" src={{asset('/images/product/product-1.png')}} alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <button title="Quick View" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><img class="injectable"
                                                    src={{asset('/images/icon-img/eye.svg')}} alt=""></button>
                                            <button title="Add To Cart"><img class="injectable"
                                                    src={{asset('/images/icon-img/bag-2.svg')}} alt=""></button>
                                            <button title="Wishlist"><img class="injectable"
                                                    src={{asset('/images/icon-img/heart.svg')}} alt=""></button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                                <div class="product-wrap" data-aos="fade-up" data-aos-delay="300">
                                    <div class="product-img img-zoom mb-4">
                                        <a href="product-details.html">
                                            <img class="default-img" src={{asset('/images/product/product-2.png')}} alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <button title="Quick View" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><img class="injectable"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                                <div class="product-wrap" data-aos="fade-up" data-aos-delay="400">
                                    <div class="product-img img-zoom mb-4">
                                        <a href="product-details.html">
                                            <img class="default-img" src={{asset('/images/product/product-3.png')}} alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <button title="Quick View" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><img class="injectable"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                                <div class="product-wrap" data-aos="fade-up" data-aos-delay="500">
                                    <div class="product-img img-zoom mb-4">
                                        <a href="product-details.html">
                                            <img class="default-img" src={{asset('/images/product/product-4.png')}} alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <button title="Quick View" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><img class="injectable"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                                <div class="product-wrap" data-aos="fade-up" data-aos-delay="200">
                                    <div class="product-img img-zoom mb-4">
                                        <a href="product-details.html">
                                            <img class="default-img" src={{asset('/images/product/product-5.png')}} alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <button title="Quick View" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><img class="injectable"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                                <div class="product-wrap" data-aos="fade-up" data-aos-delay="300">
                                    <div class="product-img img-zoom mb-4">
                                        <a href="product-details.html">
                                            <img class="default-img" src={{asset('/images/product/product-6.png')}} alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <button title="Quick View" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><img class="injectable"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                                <div class="product-wrap" data-aos="fade-up" data-aos-delay="400">
                                    <div class="product-img img-zoom mb-4">
                                        <a href="product-details.html">
                                            <img class="default-img" src={{asset('/images/product/product-7.png')}} alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <button title="Quick View" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><img class="injectable"
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-10">
                                <div class="product-wrap" data-aos="fade-up" data-aos-delay="500">
                                    <div class="product-img img-zoom mb-4">
                                        <a href="product-details.html">
                                            <img class="default-img" src={{asset('/images/product/product-8.png')}} alt="">
                                        </a>
                                        <div class="product-action-wrap">
                                            <button title="Quick View" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><img class="injectable"
                            ...
                            <div class="product-slider-active nav-style-2" data-aos="fade-up" data-aos-delay="200">
                                <div class="product-plr-1">
                                    <div class="product-wrap">
                                        <div class="product-img img-zoom mb-5">
                                            <a href="product-details.html">
                                                <img class="default-img" src={{asset('/images/product/product-9.png')}}
                                                    alt="">
                                            </a>
                                        </div>
                                ...
                                <div class="product-plr-1">
                                    <div class="product-wrap">
                                        <div class="product-img img-zoom mb-5">
                                            <a href="product-details.html">
                                                <img class="default-img" src={{asset('/images/product/product-10.png')}}
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="product-content-2">
        ...
        <div class="subscribe-area section-padding-5 bg-img" style="background-image:url(assets/images/bg/bg-1.png)">
            <div class="container">
                    ...
                    <div id="mc_embed_signup" class="subscribe-form" data-aos="fade-up" data-aos-delay="400">
                        <form id="mc-embedded-subscribe-form" class="validate subscribe-form-style-2" novalidate=""
                            ...
                            <div id="mc_embed_signup_scroll" class="mc-form">
                                <input class="email" type="email" required="" placeholder="Email address…" name="EMAIL"
                                    value="">
                            ...
                            <div class="row mb-n6">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-6">
                                    <div class="instagram-img" data-aos="fade-up" data-aos-delay="200">
                                        <a href="#"><img src={{asset('/images/instagram/instagram-1.png')}} alt=""></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-6">
                                    <div class="instagram-img" data-aos="fade-up" data-aos-delay="300">
                                        <a href="#"><img src={{asset('/images/instagram/instagram-2.png')}} alt=""></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-6">
                                    <div class="instagram-img" data-aos="fade-up" data-aos-delay="200">
                                        <a href="#"><img src={{asset('/images/instagram/instagram-3.png')}} alt=""></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mb-6">
                                    <div class="instagram-img" data-aos="fade-up" data-aos-delay="300">
                                        <a href="#"><img src={{asset('/images/instagram/instagram-4.png')}} alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mb-n6">
                    <div class="col-lg-6 mb-6">
                        <div class="banner-wrap img-zoom" data-aos="fade-up" data-aos-delay="200">
                            <a href="product-details.html"><img src={{asset('/images/banner/banner-1.png')}} alt=""></a>
                    ...
                    <div class="col-lg-6 mb-6">
                        <div class="banner-wrap img-zoom" data-aos="fade-up" data-aos-delay="300">
                            <a href="product-details.html"><img src={{asset('/images/banner/banner-2.png')}} alt=""></a>
                ...
                <div class="brand-logo-active">
                    <div class="brand-logo-plr-1" data-aos="fade-up" data-aos-delay="200">
                        <div class="single-brand-logo">
                            <img src={{asset('/images/brand-logo/brand-logo-1.png')}} alt="">
                        </div>
                    </div>
                    <div class="brand-logo-plr-1" data-aos="fade-up" data-aos-delay="300">
                        <div class="single-brand-logo">
                            <img src={{asset('/images/brand-logo/brand-logo-2.png')}} alt="">
                        </div>
                    </div>
                    <div class="brand-logo-plr-1" data-aos="fade-up" data-aos-delay="400">
                        <div class="single-brand-logo">
                            <img src={{asset('/images/brand-logo/brand-logo-3.png')}} alt="">
                        </div>
                    </div>
                    <div class="brand-logo-plr-1" data-aos="fade-up" data-aos-delay="500">
                        <div class="single-brand-logo">
                            <img src={{asset('/images/brand-logo/brand-logo-4.png')}} alt="">
                        </div>
                    </div>
                    <div class="brand-logo-plr-1" data-aos="fade-up" data-aos-delay="600">
                        <div class="single-brand-logo">
                            <img src={{asset('/images/brand-logo/brand-logo-5.png')}} alt="">
                        </div>
                    </div>
        ...
        <footer class="footer-area section-padding-lr-2 bg-gray">
            <div class="container-fluid">
                    ...
                    <div class="row mb-n6">
                        <div class="col-34 mb-6">
                            <div class="footer-widget footer-logo">
                                <a href="index.html"><img src={{asset('/images/logo/logo-2.png')}} alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="col-19-5 mb-6">
                            <div class="footer-widget footer-list">
                                ...
                                <div class="social-icon">
                                    <a href="#"><img class="injectable" src={{asset('/images/icon-img/facebook.svg')}}
                                            alt=""></a>
                                    <a href="#"><img class="injectable" src={{asset('/images/icon-img/twitter.svg')}}
                                            alt=""></a>
                                    <a href="#"><img class="injectable" src={{asset('/images/icon-img/instagram.svg')}}
                                            alt=""></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="footer-bottom copyright border-top-1 text-center">
                    <p>Copyright ©2021 All rights reserved | Made with <img class="injectable"
                            src={{asset('/images/icon-img/love.svg')}} alt=""> by <a
                        ...
                        <div class="row no-gutters">
                            <div class="col-lg-5 col-md-12 col-12">
                                <div class="quickview-img">
                                    <a href="product-details.html"><img src={{asset('/images/product-details/large-1.png')}}
                                            alt=""></a>
                                </div>
                                ...
                                <div class="product-details-content quickview-content">
                                    ...
                                    <div class="product-details-wishlist-compare">
                                        <div class="product-details-wishlist">
                                            <a href="#">
                                                <img class="injectable" src={{asset('/images/icon-img/heart-2.svg')}} alt="">
                                                Add to wishlist
                                            </a>
                                        </div>
                                        <div class="product-details-compare">
                                            <a href="#">
                                                <img class="injectable" src={{asset('/images/icon-img/compare.svg')}} alt="">
                                                ADD TO COMPARE
                                            </a>
                                        </div>
                                    </div>
